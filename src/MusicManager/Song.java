...
/**
 * The Song class represents a music track with a title, artist, and genre.
 * It provides methods to retrieve detailed information about the song.
 * This class is a fundamental part of the MusicManager package, serving as the data model.
 * @author arthurkroth
 */
public class Song {
    ...
    /**
     * Retrieves a string with detailed information about the song,
     * formatted with the title, artist, and genre.
